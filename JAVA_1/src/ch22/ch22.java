...
// 두 소프트웨어 시스템 간의 상호 작용을 위해 정의된 규약이나 프로토콜을 제공
...
// 1. java.lang 패키지 : 기본 데이터 유형, 예외 처리 등의 핵심 클래스
...
// 따라서 추가적인 import문 없이 사용 가능

// 2-3. 문자열 클래스 (String 클래스)
// 패키지 : java.lang
// 추가적인 import문 없이 사용 가능

// 2-4. Random 클래스
// 패키지 : java.util
// Random 클래스는 난수 생성과 관련된 기능을 제공하며, java.util 패키지에 속해 있음
// 따라서 import java.util.Random; 문을 통해 사용 가능

// 일반적으로 java.lang 패키지에 속한 클래스들은 추가적인 import 없이 사용 가능
// 그 외의 클래스들은 필요에 따라 import문을 사용하여 해당 패키지를 명시해 주어야 함
