...
// java.lang.Object 클래스는 자바에서 모든 클래스의 최상위 부모 클래스
// 모든 클래스는 기본적으로 Object 클래스를 암시적으로 상속받음

// 1. toString() 메서드 : 객체를 문자열로 표현하는 데 사용
// System.out.println(obj)와 같은 코드에서 객체를 출력할 때 자동으로 호출

// 2. equals(Object obj) 메서드 : 두 객체가 동등한지 여부를 비교하는 데 사용
...
// Clonable 인터페이스를 구현해야 하며, 적절한 예외 처리가 필요

// 6. finalize() 메서드 : 가비지 컬렉터가 객체를 수거하기 전에 호출
// Java 9부터는 이 메서드가 더이상 권장되지 않음
