...
// 기본 데이터 타입에 해당하는 int, char, boolean, double 등을 객체로 다루기 위해 제공하는 클래스
// 이러한 Wrapper 클래스는 해당 기본 데이터 타입의 값을 갖고 있고, 각종 유용한 메서드를 제공하여 객체로서의 동작을 가능하게 함
...
// 또한, 자동 박싱(autoboxing)과 자동 언박싱(unboxing)이라는 개념이 O
